...
const pt: Textos = {
  ...
  resultado: {
    ...
    clvBruto: 'Vantagem real (sem margem)',
...
const es: Textos = {
  ...
  resultado: {
    ...
    clvBruto: 'Ventaja real (sin margen)',
